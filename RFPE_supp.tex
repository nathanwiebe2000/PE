...
\end{equation}
Our algorithm empirically scales as $4.7/\epsilon$, which suggests that RFPE using the particle guess heuristic is nearly optimal given the use of Gaussian priors although some caution should be used in directly comparing the median scaling of the error and the standard deviation of the errors used in the BCRB. 
