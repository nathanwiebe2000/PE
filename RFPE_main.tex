...
This excludes many existing iterative PE (IPE) methods that achieve logarithmic scaling.  Other methods are both classically and quantumly efficient~\cite{Kit96,kitaev2002classical,higgins2007entanglement,BHB+09,SHF14}, but often fail to extract information about the phase as efficiently as their classically inefficient brethren or require many ancilla qubits.
...
\acknowledgments{We thank B. Terhal, K. Rudinger and D. Wecker for useful comments.
    \footnote{See Supplemental Material [url], which includes Refs. [33--37]}
}
