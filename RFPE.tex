...
\end{align}
The constant $1.25$ is empirically chosen to reduce the cost of RFPE.
...
We can instead cost the algorithm by the total number of applications of $U$ needed to learn the phase
(or in the case where $M$ is continuous, the total evolution time required).
